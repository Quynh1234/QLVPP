...
<?php
 class product
 {
    ...
    public function insert_product($data,$file){
              ...
              $query = "INSERT INTO tbl_sanpham (sanpham_tieude,sanpham_ma,danhmuc_id,loaisanpham_id,giamgia,sanpham_gia,soluong,tinhtrang,sapxepsp,sanpham_gioithieu,sanpham_chitiet,sanpham_baoquan,sanpham_anh) 
              VALUES 
              ('$sanpham_tieude','$sanpham_ma','$danhmuc_id','$loaisanpham_id','$giamgia','$sanpham_gia',' $soluong','$tinhtrang','$sapxepsp','$sanpham_gioithieu','$sanpham_chitiet','$sanpham_baoquan','$sanpham_anh')";
    ...
    public function show_product(){
        ...
        $query = "SELECT DISTINCT tbl_sanpham.*, tbl_danhmuc.danhmuc_ten,tbl_loaisanpham.loaisanpham_ten
    ...
    public function show_All_tk(){
        $query = "SELECT * FROM tbl_thongke ";
        $result = $this -> db ->select($query);
        return $result;
    }
