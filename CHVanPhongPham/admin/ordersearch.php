...
//$fm = new Format();
        ...
        if (isset($_REQUEST['ok'])) 
        {
            ...
            if (empty($search)) {
                ...
                echo "{";
                    echo "alert('Hãy điền thông tin vào ô!');";
                   echo" window.location.href = 'orderlistall.php'";
                echo "}";
            echo "</script>";
            } 
            else
...
<main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                           <h3>Các đơn hàng đã hoàn thành:</h3>
                        </div>
                        <div>
                          <table id="customers">
                            <tr>
                ...
                $query = "select * from tbl_payment where code_oder like '%$search%'";
                ...
                $num = mysqli_num_rows($sql);
                             ...
                             if($sql){$i=0;while($result = $sql->fetch_assoc()){$i++;
                            ?>
                          <tr>
                            <td><?php echo $i ?></td>
                            ...
                            <td> <a href="?status=0&session_idA=<?php echo $result['session_idA'] ?>"><span class="badge bg-success">Đã xử lý</span></a> 
                              </td>
